...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/splash_screen.css') }}">
...
<body>
    <div class="container-fluid vh-100 px-0 overflow-hidden">
        <div class="d-flex justify-content-center h-100">
            <div class="d-flex position-relative flex-column overflow-hidden align-items-center justify-content-center" id="app">
                <div class = "lampukiri"></div>
                <div class = "lampukanan"></div>
            
                <div id="content">
                    <h3 class="judul text-center">
                        <span class="judul-text">Events.io</span>
                        <div class="shadow"></div>
                    </h3>
                
                    <div class="buttons d-flex flex-column align-items-center">
                        <button id="btn-login" class="btn-pink mt-5">Log In</button>
                        <button id="btn-sign-up" class="btn-pink mt-3">Sign Up</button>
                    </div>
                    ...
                    <p class="text-center mt-5">
                        <a href="/home" class = "tulisan3">Continue as guest</a>
                    </p>
                </div>
