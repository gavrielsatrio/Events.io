        ...
        <div class="d-flex justify-content-center h-100">
            <div class="d-flex flex-column overflow-auto" id="app">
                ...
                <div class="d-flex flex-column mt-5">
                    <a href="/eo-account/edit-profile" class="d-flex w-100 profile-link justify-content-between py-4 text-decoration-none border-bottom-link">
                ...
                <div class="d-flex flex-column">
                    <a href="/eo-account/promo-code-collection" class="d-flex w-100 profile-link justify-content-between py-4 text-decoration-none border-bottom-link">
                        <span>Promo Code Collection</span>
                        <span>
                            <i class="bx bx-chevron-right fs-4 d-flex"></i>
                        </span>
                    </a>
